...
import Form from "../business/form/Form";
...
class CreateCard extends Component {
    ...
    errCheck() {
        ...
        reg.test(user) ? userErr = "" : userErr = "С твоими данными что-то не так"

        cvv.length === 3 ? cvvErr = "" : cvvErr = "Номер должен быть из 3-х цифр"
